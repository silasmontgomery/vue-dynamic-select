    ...
    watch: {
        ...
        value: function() {
            ...
            this.selectedOption = this.options.find( function (option) {
                return this$1.value && option[this$1.optionValue] == this$1.value[this$1.optionValue];
            });
        },
